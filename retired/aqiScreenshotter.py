# This script uses Selenium to make a screenshot of an AQI visualization generated by a webpage.
...
display = Display(visible=0, size=(680,484))
display.start()
...
def screenshotit():
    ...
    url = "https://kevinjbeaty.com/projects/dnvrite/air/air-with-chart.php"
    browser.get(url)
    content = browser.find_element('xpath','//*[@id="totalarea"]')
    time.sleep(12)
    content.screenshot("./airwidget.png")
    browser.close()
    uploadit()
...
def uploadit():
    ...
    file = open("./airwidget.png", "rb")
    ftp.storbinary("STOR airwidget.png", file)
    file.close()
    ftp.quit()
